...
class _ProviderManagerScreenStage extends State<ProviderManagerScreen> {
  ...
  void initState() {
    ...
    context.read<ServiceProvider>().initAllService("https://beauty-at-home-4a5ss6e6yq-as.a.run.app/api/v1.0/services?AccountId="+ accountId);
    super.initState();
  }
...
_navigateAndDisplaySelection(BuildContext context, ServiceModelNew service) {
  Navigator.push(context,
    MaterialPageRoute(builder: (context) => ServiceDetailScreen2(service: service,)),
  );
}
